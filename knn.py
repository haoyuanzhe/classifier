...
training_set_list = readMnistData("./data/train-images-idx3-ubyte","./data/train-labels-idx1-ubyte",training_limit)
print("Training set read.")
#Reat test set to list
test_set_list = readMnistData("./data/t10k-images-idx3-ubyte","./data/t10k-labels-idx1-ubyte",test_limit)
print("Test set read.")
